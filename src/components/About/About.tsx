      ...
      <div className={styles.aboutContainer}>
        <div className={styles.topContainer}>
          ...
          <p className={styles.text}>
            ...
            наши специалисты следят за современными трендами дизайна и создают
            наиболее релевантные проекты. <br />
            Для готового бизнеса мы можем настроить контектную или
