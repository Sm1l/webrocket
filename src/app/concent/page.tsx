      ...
      <div className={styles.concent}>
        ...
        <div className={styles.contentContainer}>
          <p>
            ...
            волей и в своем интересе, а также подтверждая свою дееспособность,
            Пользователь дает свое согласие ООО Турфирма «Машук» (ИНН
            2632097590), которое расположено по адресу Ставропольский край, г.
            Пятигорск, ул. Акопянца, д. 14, пом. 3, на обработку своих
          ...
          <p>
            ...
            1) Персональные данные, не являющиеся специальными или
            биометрическими: номер контактного телефона; адрес электронной
            почты; фамилия, имя, отчество, дата и место рождение; паспортные
            данные; данные свидетельства о рождении (для детей). 2)
          ...
          <p>
            4. Цель обработки персональных данных: 1) обработка входящих
            запросов физических лиц; 2) консультирование; 3) аналитика действий
            физического лица на сайте и функционирования сайта; 4) проведение
          ...
          <p>
            ...
            осуществляется согласно Федеральному закону №125-ФЗ «Об архивном
            деле в Российской Федерации» и иным нормативно правовым актам в
            области архивного дела и архивного хранения.
          </p>
          <p>
            8. Согласие может быть отозвано субъектом персональных данных или
            его представителем путем направления письменного заявления в ООО
            Турфирма «Машук» по адресу, указанному в начале данного Согласия.
          </p>
          <p>
            9. В случае отзыва субъектом персональных данных или его
            представителем согласия на обработку персональных данных ООО
            Турфирма «Машук» вправе продолжить обработку персональных данных без
